...
@interface KOMCreditViewController ()

@end

@implementation KOMCreditViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    UITapGestureRecognizer *tapForCreditor = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(presentDebitor)];
    ...
    [self.debitorLabel addGestureRecognizer:tapForCreditor];
...
-(void)presentDebitor {
    ...
    KOMNavViewController * nav = [self.storyboard instantiateViewControllerWithIdentifier:@"AccNav"];
    KOMDebitorTableViewController *debitorVC = [self.storyboard instantiateViewControllerWithIdentifier:@"DebitorTable"];
    [nav pushViewController:debitorVC animated:NO];
    
    debitorVC.delegate = self;
