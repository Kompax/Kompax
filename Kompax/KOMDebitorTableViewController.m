//
//  KOMDebitorTableViewController.m
//  Kompax
//
...
@interface KOMDebitorTableViewController ()

@end

@implementation KOMDebitorTableViewController
...
- (void)viewDidLoad
{
    ...
    _data = [NSMutableArray arrayWithObjects:@"小明",@"小红",@"小芳",@"小强", nil];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegate changeDebitor:string];
    [self dismissViewControllerAnimated:YES completion:nil];
